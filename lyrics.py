...
def genius(name):    
    ...
    try:
        ...
        artist_img = lyrics_json['response']['hits'][0]['result']['primary_artist']['image_url']
        artist_url = lyrics_json['response']['hits'][0]['result']['primary_artist']['url']
        name_genius = lyrics_json['response']['hits'][0]['result']['primary_artist']['name']
    except:
